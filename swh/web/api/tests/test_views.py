...
from swh.web.api.exc import NotFoundExc, BadInputExc
from swh.web.api import views


class ApiTestCase(SWHApiTestCase):
    ...
    @patch('swh.web.api.views.service')
    @istest
    ...
    def revision_directory_by_type_dir(self, mock_service):
        ...
        # when
        actual_dir_content = views._revision_directory_by(
            {'sha1_git': 'blah-id'},
    ...
    @patch('swh.web.api.views._revision_directory_by')
    @patch('swh.web.api.views.utils')
    @istest
