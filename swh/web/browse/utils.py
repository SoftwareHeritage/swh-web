...
def pygments_iframe_height_for_content(content: Optional[str]) -> str:
    """Heuristic that computes CSS height of iframe rendering code highlighted
    with pygments so all lines are displayed."""
    return (
        str((content.count("\n") + 1) * 15) + "px"
