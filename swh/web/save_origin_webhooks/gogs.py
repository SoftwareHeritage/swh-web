...
class GogsOriginSaveWebhookReceiver(OriginSaveWebhookReceiver):
    FORGE_TYPE = "Gogs"
    WEBHOOK_GUIDE_URL = "https://gogs.io/docs/features/webhook"
    REPO_TYPES = "git"
...
api_origin_save_webhook_gogs = GogsOriginSaveWebhookReceiver()
