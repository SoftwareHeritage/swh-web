...
hljs.registerLanguage('astro', require('highlightjs-astro-js'));
...
hljs.registerLanguage('dax', require('highlightjs-dax'));
hljs.registerLanguage('djot', require('highlightjs-djot'));
...
import('highlightjs-igor-pro').then(igorpro => {
  hljs.registerLanguage('igorpro', igorpro.default);
});
require('highlightjs-jaiva/dist/jaiva.min');
require('highlightjs-jsonata/dist/jsonata.min');
require('highlightjs-jolie/dist/jolie.min');
hljs.registerLanguage('kql', require('hljs-kql').default);
...
import('highlightjs-liquidsoap').then(liquidsoap => {
  hljs.registerLanguage('liquidsoap', liquidsoap.default);
});
...
hljs.registerLanguage('moonbit', require('highlightjs-moonbit/src/languages/moonbit'));
...
require('@apple/highlightjs-pkl/dist/pkl.min');
...
require('@joshraphael/highlightjs-rascript/dist/rascript.min');
...
hljs.registerLanguage('veryl', require('highlightjs-veryl'));
require('highlightjs-voltscript/dist/voltscript.min');
require('highlightjs-wgsl/dist/wgsl.min');
require('highlightjs-why3/dist/why3.min');
