...
// main highlight.js package exposed to the global scope for plugins
import './hljs';
...
import {default as hljsAstro} from 'highlightjs-astro-js';
...
import * as hljsDefineDjot from 'highlightjs-djot';
...
import {default as igorpro} from 'highlightjs-igor-pro';
import 'highlightjs-jaiva/dist/jaiva.min';
import 'highlightjs-jolie/dist/jolie.min';
import 'highlightjs-jsonata/dist/jsonata.min';
import {default as hljsKql} from 'hljs-kql';
...
import {default as hljsDefineLiquidSoap} from 'highlightjs-liquidsoap';
...
import * as moonbit from 'highlightjs-moonbit/src/languages/moonbit';
...
import '@apple/highlightjs-pkl/dist/pkl.min';
...
import '@joshraphael/highlightjs-rascript/dist/rascript.min';
...
import {default as hljsDefineIECST} from 'highlightjs-structured-text/dist/iecst.min';
import {default as svelte} from 'highlight.svelte';
...
hljs.registerLanguage('djot', hljsDefineDjot);
...
hljs.registerLanguage('igorpro', igorpro);
hljs.registerLanguage('kql', hljsKql);
hljs.registerLanguage('lean', hljsDefineLean);
hljs.registerLanguage('liquidsoap', hljsDefineLiquidSoap);
...
hljs.registerLanguage('veryl', hljsVeryl);
